...
const getImg = (image_id?: string | null) => {
  if (!image_id) return '/images/cards/google-play.png';
...
export default function GooglePlay() {
  ...
  const google_play_SLUG = "cards/google-play";
  let visible = variants.filter(v => (v.product_slug || "").toLowerCase() === google_play_SLUG);
  ...
  return (
    ...
    >
      {/* صورة الهيرو */}
      <img
        src="/images/cards/google-play.png"
        alt="google-play"
