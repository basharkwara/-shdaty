...
export default function AccountPage() {
  return (
    <main
      className="relative z-10 overflow-hidden text-white min-h-screen pt-24 pb-16 flex flex-col items-center p-6"
    ...
    >
      ...
      <div className="block md:hidden w-full mb-6 relative z-10">
        <img
          src="/images/character-shdosh.png"
          alt="character-shdosh"
          className="mx-auto h-[400px] opacity-80 pointer-events-none select-none mt-10"
        />
      </div>

      <div className="flex flex-col md:flex-row items-center justify-center w-full relative z-10">
        <div className="w-full max-w-md bg-black/60 border border-white/10 rounded-2xl p-8 text-center shadow-xl">
          <h1 className="text-2xl font-bold mb-4">مرحباً بك في حسابك 👋</h1>
          <p className="text-white/80 mb-6">
            تم تسجيل الدخول بنجاح. هذه صفحة حسابك، وسنضيف فيها معلوماتك وميزات إضافية قريباً.
          </p>
