...
const getImg = (image_id?: string | null) => {
  if (!image_id) return '/images/bloodstrike.png';
...
export default function BloodStrikePage() {
  ...
  const BLOOD_STRIKE_SLUG = "blood-strike";
  let visible = variants.filter(v => (v.product_slug || "").toLowerCase() === BLOOD_STRIKE_SLUG);
