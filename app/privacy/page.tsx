      ...
      <div className="w-full lg:pl-[300px] mt-6 md:mt-10 relative z-10">
        <div className="mx-auto max-w-3xl bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 md:p-8">
          ...
          <p className="text-white/85 leading-relaxed mb-6 text-justify">
            نلتزم في <span className="font-semibold text-white">Shdaty</span> بحماية خصوصيتك وضمان أمان بياناتك أثناء استخدامك لخدماتنا.
            توضح هذه السياسة باختصار كيف نجمع بياناتك ونستخدمها ونحميها.
          </p>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">١) البيانات التي نجمعها</h2>
          <ul className="list-disc pr-6 text-white/85 space-y-2">
            <li>الاسم والبريد الإلكتروني وبيانات الدفع الأساسية.</li>
            <li>معلومات الاستخدام لتحسين تجربتك.</li>
          </ul>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">٢) استخدام البيانات</h2>
          <ul className="list-disc pr-6 text-white/85 space-y-2">
            <li>لتنفيذ الطلبات وتحسين الخدمات.</li>
            <li>للتواصل بشأن التحديثات أو الدعم.</li>
          </ul>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">٣) الأمان</h2>
          <p className="text-white/80 leading-8">
            نستخدم تشفيراً ومعايير أمان عالية، ولا نحتفظ بمعلومات بطاقات الدفع.
          </p>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">٤) حقوقك</h2>
          <p className="text-white/80 leading-8">
            يمكنك طلب تصحيح بياناتك أو حذفها في أي وقت.
          </p>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">٥) التواصل</h2>
          <p className="text-white/80 leading-8">
            لأي استفسار، يمكنك مراسلتنا عبر البريد:
            <a href="mailto:privacy@shdaty.example" className="underline decoration-dotted mx-1">privacy@shdaty.example</a>
          </p>
        </div>
      </div>
