    ...
    >
      ...
      <div className="w-full lg:pl-[300px] mt-6 md:mt-10 relative z-10">
        <div className="mx-auto max-w-3xl bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 md:p-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">الدفع الآمن</h1>

          <p className="text-white/85 leading-relaxed mb-6 text-justify">
            نضمن في <span className="font-semibold text-white">Shdaty</span> أن تكون جميع عمليات الدفع محمية بالكامل من خلال أحدث تقنيات التشفير.
            نحن لا نحتفظ بأي بيانات خاصة ببطاقاتك أو حساباتك المصرفية.
          </p>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">١) طرق الدفع الآمنة</h2>
          <ul className="list-disc pr-6 text-white/85 space-y-2">
            <li>جميع عمليات الدفع تمر عبر بوابات دفع معتمدة مثل Stripe وPayPal.</li>
            <li>يتم تشفير البيانات باستخدام بروتوكول SSL.</li>
          </ul>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">٢) حماية بيانات المستخدم</h2>
          <ul className="list-disc pr-6 text-white/85 space-y-2">
            <li>لا نحتفظ ببيانات بطاقات الدفع بعد إتمام العملية.</li>
            <li>نراقب عمليات الدفع لاكتشاف أي نشاط غير اعتيادي.</li>
          </ul>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">٣) التزاماتك كمستخدم</h2>
          <p className="text-white/80 leading-8">
            تأكد من أن معلوماتك صحيحة وأنك تستخدم وسائل دفع آمنة موثوقة.
          </p>

          <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-3">٤) التواصل معنا</h2>
          <p className="text-white/80 leading-8">
            لأي استفسار بخصوص عمليات الدفع الآمن، يمكنك التواصل معنا عبر البريد:
            <a href="mailto:secure@shdaty.example" className="underline decoration-dotted mx-1">secure@shdaty.example</a>
          </p>
        </div>
      </div>
