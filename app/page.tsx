...
export default function HomePage() {
  return (
    <main
      className="relative z-10 overflow-hidden text-white min-h-screen pt-0 pb-16 flex flex-col items-center p-6"
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-start justify-between w-full lg:pl-[300px] -mt-16">
