...
async function getProducts(): Promise<Product[]> {
  ...
  const url =
    ...
    `&filter[category][slug][_eq]=balance` +
    `&sort=name&limit=-1`;
...
export default async function BalancePage() {
  ...
  return (
    ...
    >
      <img
        src="/images/balancearka.png"
        alt="TV Illustration"
        className="absolute left-0 top-10 h-[450px] w-auto opacity-90 pointer-events-none select-none hidden lg:block"
      />
